...
const itemSchema = new Schema({
    ...
    { type: Number, required: [true, 'Amount is required'], min: 0 },
    
    unit: 
    
    { type: String, enum: units, default: 'pcs' },
    
    expiryDate: 
    
    { type: Date, required: [true, 'Expiry date is required'] },
    
    zone: 
    
    { type: String, enum: zones, default: 'pantry' },
